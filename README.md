...
3. Run the install command: `gem install json_value_tester-2.0.0.gem`

![Installing Gem](https://apidocs.io/illustration/ruby?workspaceFolder=JsonValueTester&gemVer=2.0.0&gemName=json_value_tester&step=buildSDK)
...
In order to use the `json_value_tester` gem in the new project we must add a gem reference. Locate the `Gemfile` in the Project Explorer window under the `TestApp` project node. The file contains references to all gems being used in the project. Here, add the reference to the library gem by adding the following line: `gem 'json_value_tester', '2.0.0'`

![Add new reference to the Gemfile](https://apidocs.io/illustration/ruby?workspaceFolder=JsonValueTester&gemVer=2.0.0&gemName=json_value_tester&step=addReference)

### 3. Adding a new Rails Controller

Once the `TestApp` project is created, a folder named `controllers` will be visible in the *Project Explorer* under the following path: `TestApp > app > controllers`. Right click on this folder and select `New -> Run Rails Generator...`.

![Run Rails Generator on Controllers Folder](https://apidocs.io/illustration/ruby?workspaceFolder=JsonValueTester&gemVer=2.0.0&gemName=json_value_tester&step=addCode0)
...
![Add a new Controller](https://apidocs.io/illustration/ruby?workspaceFolder=JsonValueTester&gemVer=2.0.0&gemName=json_value_tester&step=addCode2)
...
**_Note:_** Documentation for the client can be found [here.](https://www.github.com/sufyankhanrao/test-ruby-sdk/tree/2.0.0/doc/client.md)
...
* [Json Obj](https://www.github.com/sufyankhanrao/test-ruby-sdk/tree/2.0.0/doc/controllers/json-obj.md)
* [Json Val](https://www.github.com/sufyankhanrao/test-ruby-sdk/tree/2.0.0/doc/controllers/json-val.md)

## Classes Documentation

* [Utility Classes](https://www.github.com/sufyankhanrao/test-ruby-sdk/tree/2.0.0/doc/utility-classes.md)
* [HttpResponse](https://www.github.com/sufyankhanrao/test-ruby-sdk/tree/2.0.0/doc/http-response.md)
* [HttpRequest](https://www.github.com/sufyankhanrao/test-ruby-sdk/tree/2.0.0/doc/http-request.md)
